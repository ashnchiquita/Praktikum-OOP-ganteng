 ...
 * - cls.getDeclaredFields() -> mengembalikan array dari semua field yang ada di
 * kelas cls.
 * - cls.getDeclaredField(field) -> mengembalikan field dengan nama field dari
 * kelas cls.
 * - cls.getDeclaredMethods() -> mengembalikan array dari semua method yang ada
 * di kelas cls.
 * - cls.getDeclaredMethod(method, parameterTypes...) -> mengembalikan method
 * dengan nama method dan parameter parameterTypes dari kelas cls.
 * - field.get(obj) -> mengembalikan nilai dari field obj.
 * - field/method.setAccessible(true) -> mengubah aksesibilitas dari
 * field/method menjadi true.
 * - field/method/cls.getName() -> mengembalikan nama dari field/method.
 * - method.invoke(obj, args...) -> mengembalikan nilai dari method obj.
 * - method.getParameterTypes() -> mengembalikan array tipe parameter dari
 * method.
 * - method.getReturnType() -> mengembalikan tipe return dari method.
 * - param.getType() -> mengembalikan tipe dari parameter param.
 * - Modifier.toString(field/method/cls.getModifiers()) -> mengembalikan string
 * representasi dari modifier field/method.
...
public class Detective {
    ...
    /**
     * Fungsi untuk mendapatkan string random dengan panjang random dari 1 sampai
     * 10.
     * 
    ...
    /**
     * Fungsi untuk mendapatkan attribute dari suatu kelas yang menyerupai
     * MysteriousCase.
     * Apabila terjadi error, maka return string kosong, dan
     * - Print "Illegal Access Exception" apabila reflection dilakukan dengan akses
     * yang kurang
     * - Print "No Such Field Exception" apabila field tidak ditemukan.
     * 
     * @param attr          Attribute yang ingin didapatkan.
     * @param setAccessible apabila true maka lakukan setAccessible(true) pada
     *                      field.
    ...
    /**
     * Fungsi untuk mengeksekusi method dari suatu kelas yang menyerupai
     * MysteriousCase.
     * Method yang dapat diproses oleh fungsi ini adalah method yang tidak memiliki
     * parameter.
     * Apabila terjadi error, maka return string kosong, dan
     * - Print "Illegal Access Exception" apabila reflection dilakukan dengan akses
     * yang kurang
     * - Print "Illegal Argument Exception" apabila jumlah parameter yang diberikan
     * tidak sesuai.
    ...
    /**
     * Fungsi untuk mengeksekusi method dari suatu kelas yang menyerupai
     * MysteriousCase dengan
     * parameter.
     * 
     * Ingat bahwa parameter yang dapat diterima oleh method di MysteriousCase hanya
     * bertipe
     * Integer dan String, oleh karena itu, apabila terdapat parameter yang bukan
     * Integer atau
     * String, maka return string kosong. Parameter akan digenerate secara random
     * dengan
     ...
     * @param pType         tipe parameter yang ingin dipanggil, dipastikan hanya
     *                      Integer atau String.
     * @return String representasi string dari hasil eksekusi method.
     */
    public String investigateSecretMethodWithParam(
        ...
        // m.invoke(obj, params)
        if (!pType.equals(Integer.class) && !pType.equals(String.class)) {
            return "";
        }
        ...
        try {
            ...
            Class<?>[] paramsClass = new Class<?>[nParam]; // TODO : didieu
            for (int i = 0; i < nParam; i++) {
                if (pType.equals(Integer.class)) {
            ...
            Method m = cls.getDeclaredMethod(method, paramsClass); // selalu loncat di sini
    ...
    /**
     * Fungsi untuk mendapatkan berapa jumlah Integer digunakan sebagai sebagai
     * parameter method,
    ...
    /**
     * Fungsi untuk mendapatkan berapa jumlah String digunakan sebagai parameter
     * method, return
    ...
    /**
     * Fungsi untuk melakukan print seluruh signature method yang ada pada kelas
     * yang menyerupai MysteriousCase.
     * Format output:
     * {modifier} {return_type} {method_name}(parameter_type1,...parameter_typeN))
     * Contoh output:
     * public Integer mysteryM2(String, Integer)
     * 
     * Refer ke note cara untuk mendapatkan modifier, return_type, method_name, dan
     * parameter_type.
     * 
     * @param obj Objek dari kelas yang menyerupai MysteriousCase.
     */
    ...
    /**
     * Fungsi untuk melakukan print seluruh signature attribute yang ada pada kelas
     * yang menyerupai
     * MysteriousCase.
     * Format output:
